    ...
    <AppShell>
      <div className="border-b border-gray-100 dark:border-gray-800 bg-white/70 dark:bg-gray-900/70 backdrop-blur-sm">
        <div className="max-w-2xl mx-auto px-6 py-10 text-center">
          <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">How We Work</h1>
      ...
      <div className="max-w-2xl mx-auto px-6 py-12 space-y-10">
        ...
        <section>
          ...
          <div className="space-y-3">
            {[
              ...
              <div key={item.title} className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-2xl p-5 flex gap-3">
                <item.icon className="w-5 h-5 flex-shrink-0 text-gray-500 dark:text-gray-400 mt-0.5" />
                <div>
                  <p className="font-medium text-gray-800 dark:text-gray-200 text-sm">{item.title}</p>
                  <p className="text-xs text-gray-500 dark:text-gray-400 mt-1 leading-relaxed">{item.body}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <section>
          ...
          <div className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-2xl p-5 space-y-4">
            <div className="flex gap-3">
              <Lock className="w-5 h-5 flex-shrink-0 text-gray-500 dark:text-gray-400 mt-0.5" />
              <div>
                <p className="font-medium text-gray-800 dark:text-gray-200 text-sm">One deterministic table, not a sales conversation</p>
            ...
            <div className="flex gap-3">
              <Sprout className="w-5 h-5 flex-shrink-0 text-gray-500 dark:text-gray-400 mt-0.5" />
              <div>
                <p className="font-medium text-gray-800 dark:text-gray-200 text-sm">Behavioral practice is never optional</p>
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-1 leading-relaxed">
            ...
            <div className="flex gap-3">
              <Target className="w-5 h-5 flex-shrink-0 text-gray-500 dark:text-gray-400 mt-0.5" />
              <div>
                <p className="font-medium text-gray-800 dark:text-gray-200 text-sm">Tendencies, never verdicts</p>
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-1 leading-relaxed">
        ...
        <section>
          ...
          <div className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-2xl p-5">
            ...
            <div className="grid sm:grid-cols-2 gap-3">
              <div className="border border-purple-100 dark:border-purple-900/60 bg-purple-50/50 dark:bg-purple-950/40 rounded-xl p-4">
                <p className="text-sm font-semibold text-purple-800 dark:text-purple-200">🕉 Traditional Voice</p>
                <p className="text-xs text-purple-700/80 dark:text-purple-300/80 mt-1.5 leading-relaxed">
                  Full Jyotish vocabulary — karma, dharma, guna, upaya — for anyone fluent or
                  learning the tradition.
                </p>
              </div>
              <div className="border border-sky-100 dark:border-sky-900/60 bg-sky-50/50 dark:bg-sky-950/40 rounded-xl p-4">
                <p className="text-sm font-semibold text-sky-800 dark:text-sky-200">🎯 Plain Language</p>
                <p className="text-xs text-sky-700/80 dark:text-sky-300/80 mt-1.5 leading-relaxed">
        ...
        <p className="text-center text-xs text-gray-500 dark:text-gray-400">
          Questions about your data? See <Link href="/profile" className="underline hover:text-gray-500 dark:hover:text-gray-400">Profile &amp; Settings</Link>.
        </p>
      </div>
    </AppShell>
  );
