  ...
  return (
    <AppShell>
      <div className="max-w-xl mx-auto px-4 py-10">
        ...
        {!config ? (
          <p className="text-center text-sm text-gray-500 dark:text-gray-400 bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-2xl p-6">
          ...
          <div className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-2xl shadow-sm p-6">
            <p className="text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-gray-400 mb-2">Choose an amount</p>
            <div className="flex flex-wrap gap-2">
                ...
                return (
                  <button
                    ...
                    className={`px-4 py-2 rounded-xl text-sm font-semibold border transition-colors ${
                      active ? "bg-indigo-600 text-white border-indigo-600" : "border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800/50"
                    }`}
                  >
                    ₹{a}
                  </button>
              ...
              <label className="flex items-center gap-1 rounded-xl border border-gray-200 dark:border-gray-700 px-3 py-2 text-sm text-gray-700 dark:text-gray-300 focus-within:ring-2 focus-within:ring-indigo-500">
                ₹
                <input
                  inputMode="numeric"
                  value={custom}
            ...
            {customInvalid && (
              <p className="text-xs text-red-600 dark:text-red-400 mt-2">Enter a whole amount between ₹1 and ₹{SUPPORT_MAX_AMOUNT.toLocaleString("en-IN")}.</p>
            )}
            ...
            <div className="mt-6 grid gap-6 sm:grid-cols-2 items-center">
              <div className="flex flex-col items-center">
                {qrSvg ? (
                  <div
                    className="w-[220px] h-[220px] rounded-xl border border-gray-100 dark:border-gray-800 p-1 bg-white dark:bg-gray-900"
                  ...
                  <div className="w-[220px] h-[220px] rounded-xl bg-gray-50 dark:bg-gray-800/50 animate-pulse" />
                )}
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between gap-2 rounded-xl bg-gray-50 dark:bg-gray-800/50 border border-gray-100 dark:border-gray-800 px-3 py-2">
                  <div className="min-w-0">
                    <p className="text-[11px] text-gray-500 dark:text-gray-400">UPI ID · {config.payeeName}</p>
                    <p className="text-sm font-mono text-gray-900 dark:text-gray-100 truncate">{config.upiId}</p>
                  </div>
                  <button type="button" onClick={copyId} className="shrink-0 inline-flex items-center gap-1 text-xs text-indigo-600 dark:text-indigo-400 hover:text-indigo-800 dark:hover:text-indigo-200">
