...
- "shouldTransitionToRecommending" should be true if ANY of these conditions is met:
  1. exchange >= 3 (enough exchanges have passed — stop gathering, start recommending)
  2. exchange >= 1 AND the user has revealed at least ONE of: current life situation, a recurring struggle, a specific behavior pattern, a stated goal, or a concrete block
  3. The coach has asked 2+ questions already — pivot to recommendations now
...
- Be AGGRESSIVELY decisive — this person came for guidance, not an interview. Err strongly toward transitioning sooner; waiting for more data than this delays useful guidance and makes the person feel interrogated rather than helped.
